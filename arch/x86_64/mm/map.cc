...
bool map(addr_t v, addr_t p, int flags)
{
    ...
    int r = 0;
    r     = __set_address(&pml4->pages[memory::x86_64::pml4_index(v)]);
    ...
    r = __set_address(&pdpt->pages[memory::x86_64::pdpt_index(v)]);
    ...
    r = __set_address(&pd->pages[memory::x86_64::pd_index(v)]);
    ...
    pt->pages[memory::x86_64::pt_index(v)].address = p / 0x1000;
