...
PCI_VENTABLE	PciVenTable [] =
{
	...
	{ 0x13B5, "", "ARM Ltd" } ,
	{ 0x13B6, "pci", "DLoG Gesellschaft f�r elektronische Datentechnik mbH" } ,
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x5333, 0x8811, "8622mcq04", "Strawberry 64/64V" } ,
	{ 0x5333, 0x8812, "86CM65?", "Aurora 64V+" } ,
	{ 0x5333, 0x8813, "86C764", "Strawberry 32/64 GUI Accelerator v3" } ,
	{ 0x5333, 0x8814, "86C767", "Strawberry 64UV+" } ,
	...
	{ 0x1033, 0x0194, "�PD720200", "host controller compliant with the USB 3.0 and xHCI " } ,
	...
	{ 0x131F, 0x2042, "", "Strawberry 1S(16850)+2P" } ,
	...
	{ 0x131F, 0x2060, "JJ_P21022-B", "Strawberry 2S(16550)+1P" } ,
	{ 0x131F, 0x2061, "", "Strawberry 2S(16650)+1P" } ,
	{ 0x131F, 0x2062, "", "Strawberry 2S(16850)+1P" } ,
	...
	{ 0x109E, 0x0351, "B t878 khf", "Descripci�n del dispositivo	Tipo BrookTree Bt878 Video Capture Device - Audio Section	PCI" } ,
	...
	{ 0x11BD, 0x1158, "48", "sp�cialit� �lectronique et informatique" } ,
