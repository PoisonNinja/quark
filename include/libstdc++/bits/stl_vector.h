        ...
        struct _Vector_impl : public _Tp_alloc_type {
            ...
            struct _Asan {
                typedef typename __gnu_cxx::__alloc_traits<
                    _Tp_alloc_type>::size_type size_type;
            ...
            struct _Asan<allocator<_Up>> {
                                      ...
                                      pointer __curr)
                {
                    __sanitizer_annotate_contiguous_container(
                        __impl._M_start, __impl._M_end_of_storage, __prev,
                        __curr);
                }
                ...
                struct _Reinit {
                    explicit _Reinit(_Vector_impl& __impl)
                        : _M_impl(__impl)
                    {
                        // Mark unused capacity as valid again before
                        // deallocating it.
...
#define _GLIBCXX_ASAN_ANNOTATE_BEFORE_DEALLOC
        ...
        __glibcxx_class_requires(_Tp, _SGIAssignableConcept)
            ...
            __glibcxx_class_requires2(_Tp, _Alloc_value_type, _SameTypeConcept)
                ...
                static_assert(
                    ...
                    "std::vector must have a non-const, non-volatile "
                    "value_type");
    ...
    public:
         ...
         *  @param  __first  Iterator pointing to the first element to be
         * erased.
    ...
    protected:
        ...
        private:
            pointer _M_ptr()
            {
                return pointer_traits<pointer>::pointer_to(_M_val());
            }
