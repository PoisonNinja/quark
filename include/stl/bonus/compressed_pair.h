...
#include <stl/bonus/call_traits.h>     
	...
	EA_DISABLE_VC_WARNING(4626 5027) // warning C4626: 'stl::compressed_pair_imp<T1,T2,0>': assignment operator was implicitly defined as deleted because a base class assignment operator is inaccessible or deleted
#endif
