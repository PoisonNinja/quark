...
#include <stl/fixed_vector.h>
#include <stl/bonus/ring_buffer.h>
...
namespace stl
{
	...
	/// ring_buffer using stl::fixed_vector as its storage container. This has
	/// been tricky for users to get correct due to the constructor requirements
	/// of stl::ring_buffer leaking the implementation detail of the sentinel
