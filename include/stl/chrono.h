...
///////////////////////////////////////////////////////////////////////////////
// This file implements the stl::chrono specification which is part of the
// standard STL date and time library.  stl::chrono implements all the
...
namespace chrono
{
	...
	public:
		...
		EASTL_FORCE_INLINE static EA_CONSTEXPR Rep max()  { return stl::numeric_limits<Rep>::max(); }
		EASTL_FORCE_INLINE static EA_CONSTEXPR Rep min()  { return stl::numeric_limits<Rep>::lowest(); }
	};
	...
	namespace Internal
	{
		...
		// IsRatio 
		///////////////////////////////////////////////////////////////////////////////
		template <typename> struct IsRatio                                           : stl::false_type {};
		template <intmax_t N, intmax_t D> struct IsRatio<ratio<N, D>>                : stl::true_type {};
		template <intmax_t N, intmax_t D> struct IsRatio<const ratio<N, D>>          : stl::true_type {};
		template <intmax_t N, intmax_t D> struct IsRatio<volatile ratio<N, D>>       : stl::true_type {};
		template <intmax_t N, intmax_t D> struct IsRatio<const volatile ratio<N, D>> : stl::true_type {};


		///////////////////////////////////////////////////////////////////////////////
		// IsDuration 
		///////////////////////////////////////////////////////////////////////////////
		template<typename> struct IsDuration                                                            : stl::false_type{};
		template<typename Rep, typename Period> struct IsDuration<duration<Rep, Period>>                : stl::true_type{};
		template<typename Rep, typename Period> struct IsDuration<const duration<Rep, Period>>          : stl::true_type{};
		template<typename Rep, typename Period> struct IsDuration<volatile duration<Rep, Period>>       : stl::true_type{};
		template<typename Rep, typename Period> struct IsDuration<const volatile duration<Rep, Period>> : stl::true_type{};
		...
		struct RatioGCD
		{
			static_assert(IsRatio<Period1>::value, "Period1 is not a stl::ratio type");
			static_assert(IsRatio<Period2>::value, "Period2 is not a stl::ratio type");

			typedef ratio<stl::Internal::gcd<Period1::num, Period2::num>::value,
			              stl::Internal::lcm<Period1::den, Period2::den>::value> type;
		};
	};
	...
	namespace Internal
	{
		template <typename FromDuration,
		          ...
		          typename CommonRep = typename stl::decay<typename stl::common_type<typename ToDuration::rep,
	...
	inline typename stl::enable_if<Internal::IsDuration<ToDuration>::value, ToDuration>::type 
	...
	public:
		...
		inline EA_CONSTEXPR explicit duration(
		    const Rep2& rep2,
		    typename stl::enable_if<stl::is_convertible<Rep2, Rep>::value &&
		...
		EA_CONSTEXPR duration(const duration<Rep2, Period2>& d2,
		                      typename stl::enable_if<treat_as_floating_point<Rep>::value ||
		                                                    (stl::ratio_divide<Period2, Period>::type::den == 1 &&
	...
	typename stl::common_type<duration<Rep1, Period1>, duration<Rep2, Period2>>::type EASTL_FORCE_INLINE
	operator+(const duration<Rep1, Period1>& lhs, const duration<Rep2, Period2>& rhs)
	{
		typedef typename stl::common_type<duration<Rep1, Period1>, duration<Rep2, Period2>>::type common_duration_t;
	...
	duration<typename stl::common_type<Rep1, Rep2>::type, Period1> EASTL_FORCE_INLINE
	operator*(const duration<Rep1, Period1>& lhs, const Rep2& rhs)
	{
		typedef typename duration<stl::common_type<Rep1, Rep2>, Period1>::type common_duration_t;
		return common_duration_t(common_duration_t(lhs).count() * rhs);
	}

	template <typename Rep1, typename Rep2, typename Period2>
	duration<typename stl::common_type<Rep1, Rep2>::type, Period2> EASTL_FORCE_INLINE
	operator*(const Rep1& lhs, const duration<Rep2, Period2>& rhs)
	{
		typedef duration<typename stl::common_type<Rep1, Rep2>::type, Period2> common_duration_t;
	...
	operator/(const duration<Rep1, Period1>& lhs, const Rep2& rhs)
	{
		typedef duration<typename stl::common_type<Rep1, Rep2>::type, Period1> common_duration_t;
		return common_duration_t(common_duration_t(lhs).count() / rhs);
	}
	...
	public:
		...
		inline EA_CONSTEXPR time_point(
		    ...
		    typename stl::enable_if<stl::is_convertible<Duration2, Duration>::value>::type** = 0)
	...
	inline EA_CONSTEXPR time_point<Clock, typename stl::common_type<Duration1, duration<Rep2, Period2>>::type>
	operator+(const time_point<Clock, Duration1>& lhs, const duration<Rep2, Period2>& rhs)
	{
		typedef time_point<Clock, typename stl::common_type<Duration1, duration<Rep2, Period2>>::type> common_timepoint_t;
		return common_timepoint_t(lhs.time_since_epoch() + rhs);
	}

	template <class Rep1, class Period1, class Clock, class Duration2>
	inline EA_CONSTEXPR time_point<Clock, typename stl::common_type<Duration2, duration<Rep1, Period1>>::type>
	operator+(const duration<Rep1, Period1>& lhs, const time_point<Clock, Duration2>& rhs)
	{
		typedef time_point<Clock, typename stl::common_type<Duration2, duration<Rep1, Period1>>::type> common_timepoint_t;
	...
	inline EA_CONSTEXPR typename stl::common_type<Duration1, Duration2>::type operator-(
	...
	EA_CONSTEXPR time_point<Clock, ToDuration> time_point_cast(
	    ...
	    typename stl::enable_if<Internal::IsDuration<ToDuration>::value>::type** = 0)
	{
	...
	namespace Internal
	{
		...
		#else
			typedef stl::ratio_multiply<stl::ratio<EASTL_NS_PER_TICK, 1>, nano>::type SystemClock_Period; 
			typedef stl::ratio_multiply<stl::ratio<EASTL_NS_PER_TICK, 1>, nano>::type SteadyClock_Period; 
		#endif
	...
	{
	    typedef chrono::duration<typename stl::decay<typename stl::common_type<Rep1, Rep2>::type>::type,
	...
	{
		typedef chrono::time_point<Clock, typename stl::common_type<Duration1, Duration2>::type> type;
	};
...
namespace chrono
{
	using namespace stl::literals::chrono_literals;
} // namespace chrono
#endif
