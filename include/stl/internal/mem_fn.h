...
//
// We implement only enough of mem_fn to implement stl::function.
////////////////////////////////////////////////////////////////////////////////
...
namespace stl
{
	...
	private:
		...
		template <class U>
		static stl::yes_type test(typename U::result_type* = 0);
	...
	public:
		static const bool value = !is_same<decltype(test((T*)0)), stl::no_type>::value;
	...
	class mem_fn_impl 
		...
		// Due to a (seemingly random) internal compiler error on VS2013 we disable stl::unary_function and
		// binary_function support for stl::mem_fn as its not widely (if at all) used.  If you require this support
	...
	public:
	    ...
	    {
		    return invoke(func, stl::forward<ArgTypes>(args)...);
	    }
#else
