...
#include <stl/internal/intrusive_hashtable.h>
...
namespace stl
{
	...
	///
	template <typename Key, typename T, size_t bucketCount, typename Hash = stl::hash<Key>, typename Equal = stl::equal_to<Key> >
