...
// *** stl::unique_ptr template class found in <stl/unique_ptr.h>       *** 
///////////////////////////////////////////////////////////////////////////////
...
#include <stl/internal/smart_ptr.h>   // Defines smart_array_deleter
...
namespace stl
{
	...
	/// Example usage:
	///    UNIQUE_ARRAY_T(int, stl::smart_ptr_deleter<int>) uniqueIntArray;
	///
