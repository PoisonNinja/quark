...
namespace stl
{
	...
	///
		...
		#define EASTL_SET_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " set" // Unless the user overrides something, this is "stl set".
	#endif
	...
	///
		...
		#define EASTL_MULTISET_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " multiset" // Unless the user overrides something, this is "stl multiset".
	#endif
	...
	class set
		: public rbtree<Key, Key, Compare, Allocator, stl::use_self<Key>, false, true>
	{
	public:
		typedef rbtree<Key, Key, Compare, Allocator, stl::use_self<Key>, false, true> base_type;
	...
	public:
		...
		stl::pair<iterator, iterator>             equal_range(const Key& k);
		stl::pair<const_iterator, const_iterator> equal_range(const Key& k) const;
	...
	template <typename Key, typename Compare = stl::less<Key>, typename Allocator = EASTLAllocatorType>
	class multiset
		: public rbtree<Key, Key, Compare, Allocator, stl::use_self<Key>, false, false>
	{
	public:
		typedef rbtree<Key, Key, Compare, Allocator, stl::use_self<Key>, false, false>    base_type;
	...
	public:
		...
		stl::pair<iterator, iterator>             equal_range_small(const Key& k);
		stl::pair<const_iterator, const_iterator> equal_range_small(const Key& k) const;
	...
	template <typename Key, typename Compare, typename Allocator>
	inline stl::pair<typename set<Key, Compare, Allocator>::iterator,
	...
	template <typename Key, typename Compare, typename Allocator>
	inline stl::pair<typename set<Key, Compare, Allocator>::const_iterator, 
	...
	{
		const stl::pair<iterator, iterator> range(equal_range(k));
	...
	{
		const stl::pair<const_iterator, const_iterator> range(equal_range(k));
	...
	template <typename Key, typename Compare, typename Allocator>
	inline stl::pair<typename multiset<Key, Compare, Allocator>::iterator,
	...
	multiset<Key, Compare, Allocator>::equal_range(const Key& k)
	{
		...
		// is this:
		//    return stl::pair<iterator, iterator>(lower_bound(k), upper_bound(k));
		//
	...
	template <typename Key, typename Compare, typename Allocator>
	inline stl::pair<typename multiset<Key, Compare, Allocator>::const_iterator, 
