...
namespace stl
{
	...
	///
		...
		#define EASTL_VECTOR_MULTISET_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " vector_multiset" // Unless the user overrides something, this is "stl vector_multiset".
	#endif
	...
	{
		const stl::pair<iterator, iterator> pairIts(stl::equal_range(begin(), end(), u, predicate));
		return (pairIts.first != pairIts.second) ? pairIts.first : end();
	}
	...
	{
		const stl::pair<const_iterator, const_iterator> pairIts(stl::equal_range(begin(), end(), u, predicate));
		return (pairIts.first != pairIts.second) ? pairIts.first : end();
	}
	...
	template <typename K, typename C, typename A, typename RAC>
	inline stl::pair<typename vector_multiset<K, C, A, RAC>::iterator, typename vector_multiset<K, C, A, RAC>::iterator>
	vector_multiset<K, C, A, RAC>::equal_range(const key_type& k)
	{
		return stl::equal_range(begin(), end(), k, mCompare);
	}


	template <typename K, typename C, typename A, typename RAC>
	inline stl::pair<typename vector_multiset<K, C, A, RAC>::const_iterator, typename vector_multiset<K, C, A, RAC>::const_iterator>
