...
void Process::set_cwd(std::shared_ptr<Filesystem::Descriptor> desc)
{
    cwd = desc;
}

void Process::set_root(std::shared_ptr<Filesystem::Descriptor> desc)
{
    root = desc;
}

void Process::set_dtable(std::shared_ptr<Filesystem::DTable> table)
{
    fds = table;
}

std::shared_ptr<Filesystem::Descriptor> Process::get_cwd()
{
    return cwd;
}

std::shared_ptr<Filesystem::Descriptor> Process::get_root()
{
    return root;
}

std::shared_ptr<Filesystem::DTable> Process::get_dtable()
{
    return fds;
}
...
Process* Process::fork()
{
    ...
    child->set_dtable(std::shared_ptr<Filesystem::DTable>(
